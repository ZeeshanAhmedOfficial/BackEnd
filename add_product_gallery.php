...
if (isset($_POST['is_submit']) && $_POST['is_submit'] == 1 )
{
  ...
  if(isset($_FILES['file']))
  {
      ...
      {
        $isUploaded = move_uploaded_file($file_tmp, "../uploads/gallery/" . $file_name);

        if($isUploaded)
        {
            mysql_query("INSERT INTO itl0_product_gallery(product_id, gallery_img) 
    ...
    <div class="span12">
      ...
      <div id="main-content" role="main"> 
        ...
        <section class="dark-box" id="inner-header">
          <div class="row">
            <div class="span5">
              <h1 class="article-page-title ic-48-article">Add Product Gallery</h1>
            </div>
